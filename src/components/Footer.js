      ...
      <Container>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" paragraph>
              Aspiring Software Developer Engineer specializing in full-stack development, and machine learning.
            </Typography>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" sx={{ mb: 1 }}>
              <strong>Email:</strong> saicharankasarapu2004@gmail.com
            </Typography>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
          <Typography variant="body2" color="text.secondary">
            © {currentYear} Sai Charan - All Rights Reserved.
          </Typography>
        </Box>
      </Container>
    </Box>
